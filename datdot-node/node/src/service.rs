...
native_executor_instance!(
	pub Executor,
	datdot_runtime::api::dispatch,
	datdot_runtime::native_version,
);
...
macro_rules! new_full_start {
	($config:expr) => {{
		...
		let builder = sc_service::ServiceBuilder::new_full::<
			datdot_runtime::primitives::Block, datdot_runtime::RuntimeApi, crate::service::Executor
		>($config)?
...
pub fn new_light(config: Configuration) -> Result<impl AbstractService, ServiceError> {
	...
	let service = ServiceBuilder::new_light::<Block, RuntimeApi, crate::service::Executor>(config)?
		.with_select_chain(|_config, backend| {
